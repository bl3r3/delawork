...
export default function Home() {
  return (
    <>
      <ScrollToTop />
      <Navbar color="#0052A1" textColor="#fff" home />
      {/* {Hero} */}
      <section className="min-[320px]:h-fit md:h-fit lg:h-screen w-screen flex flex-col">
        <div className="flex min-[320px]:px-12 items-center justify-start gap-6 mt-32 max-[1200px]:px-14 min-[1200px]:px-48 md:pt-24">
      ...
      <section className="flex flex-col w-full h-auto bg-gradient-to-b from-white  to-gradient items-center justify-start gap-10 min-[320px]:px-12 md:px-14  max-[1200px]:px-14 min-[1200px]:px-48">
        <div className="flex w-screen min-[320px]:px-12 min-[320px]:justify-center min-[320px]:mt-12 md:px-20 max-[1200px]:px-14 min-[1200px]:px-48  md:justify-start">
        ...
        <div className="flex w-screen min-[320px]:px-12 md:px-12 mb-12 max-[1200px]:px-14 min-[1200px]:px-48">
          <div className="bg-white p-2 w-75 shadow-2xl">
            <h3 className="text-corporativo text-4xl min-[320px]:text-center md:text-left font-bold">
              ¿QUIERES EMPRENDER?
            </h3>
          </div>
        </div>
